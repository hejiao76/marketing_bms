<template>
  <div class="con_list">
    <el-form :model="filterForm" :inline="true" ref="filterForm">
      <el-form-item label="手机号/姓名/车牌号" prop="userPhone">
        <el-input style="width: 190px;" v-model="filterForm.userPhone" placeholder="请输入手机号/姓名/车牌号" ></el-input>
      </el-form-item>
      <el-form-item class="fr">
        <el-button type="primary" @click="truck_searchFn">查询</el-button>
        <el-button  @click="truck_resetForm">重置</el-button>
      </el-form-item>
    </el-form>
    <hr class="hr_line">
    <el-table class="table_min_height" :data="resData" ref="singleTable" border highlight-current-row style="width: 100%;">
      ...
      <el-table-column prop="vehicleLicenseNo" label="车牌号" align="center" width="140"></el-table-column>
      <el-table-column prop="vehicleType" label="车辆信息" align="center" width="140"></el-table-column>
      <el-table-column prop="vehicleLength" label="车长信息" align="center" width="140"></el-table-column>
      <el-table-column prop="authType" align="center" label="认证类型" width="95" :formatter="authTypeFormat"></el-table-column>
      <el-table-column prop="submitTime" align="center" min-width="200" label="提交时间" :formatter="dateFormat"></el-table-column>
      <el-table-column prop="auditTime" align="center" min-width="200" label="审核时间" :formatter="dateFormat"></el-table-column>
      <el-table-column  label="操作" align="center" width="150">
        <template  scope="scope">
          ...
          <div v-if="Final.ZHUCANG_QUERYTYPE[2].includes(scope.row.status)">
            <el-button size="small" @click="toDetailInfo(scope.row.id)">查看</el-button>
  ...
  export default {
    ...
    watch: {
      "$route": function (to, from) {
        ...
        this.truck_resetForm();
      }
    },
    methods:{
      //跳转审核详情页面
      toDetail(truckInfoId){
        this.$router.push({ name: 'truckDetail',params : {truckInfoId:truckInfoId} })
      },
      //跳转查看详情页面
      toDetailInfo(truckInfoId){
        this.$router.push({ name: 'truckDetailInfo',params : {truckInfoId:truckInfoId} })
      },
      //时间转换
      ...
      revokeAudit (driverInfoId) {
        if(driverInfoId){
          let param={id:driverInfoId};
          Api.truck_revoke_audit(param)
            .then(res => {
              if(res.status==1){
