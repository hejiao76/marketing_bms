      ...
      methods : {
        ...
        revokeAudit (driverInfoId) {
          if(driverInfoId){
            ...
            Api.lc_driver_revoke_audit(param)
              .then(res => {
                if(res.status==1){
//                  this.$message({
//                    message: '撤销成功',
...
//                  });
        ...
        toDetail (driverInfoId){
          this.$router.push({ name: 'driverDetail',params : {driverInfoId:driverInfoId} })
        },
        toDetailInfo (driverInfoId) {
          this.$router.push({ name: 'driverDetailInfo',params : {driverInfoId:driverInfoId} })
        },
//        /**
//         * 获取过滤器参数
...
//         */
//        getFilterParam () {
//            var param={token:localStorage.getItem("token"),queryType:this.checkStatus}
//          return param;
//        },
        searchFn () {
            this.currentPage=1;
...
//            var p=this.getFilterParam();
            ...
            Api.lc_driver_check_list(param)
            .then(res => {
                if(res.status==1){
